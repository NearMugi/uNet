...
def get_parser():
    ...
    parser.add_argument(
        "-t", "--trainrate", type=float, default=0.85, help="Training rate"
    )
    parser.add_argument(
        "-a", "--augmentation", action="store_true", help="Number of epochs"
    )
    parser.add_argument(
        "-r", "--l2reg", type=float, default=0.0001, help="L2 regularization"
    )
